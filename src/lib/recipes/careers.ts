...
export const CAREERS: Career[] = [
  ...
  // Batch two. Written against the whole catalogue rather than the teams the
  // file already named, which is what added Sevilla, Benfica, Brazil and the
  // rest below. Most of these cover five clubs and stop; they are kept because
  // the picker re-tests every career on every load, so each one appears on its
  // own the week the shirt it is waiting for arrives.
  {
    key: "chicharito",
    ...
    spells: [
      ...
      { team: "Real Madrid", from: 2014, to: 2014, loan: true, apps: 33 },
      { team: "Bayer Leverkusen", from: 2015, to: 2016 },
      { team: "West Ham United", from: 2017, to: 2018, england: "top" },
      { team: "Sevilla", from: 2018, to: 2019 },
    ],
    notes: [
      "Arrived in England from the club his grandfather had played for",
      "His father and his grandfather both went to World Cups before he did",
      "A loan season in Spain in the middle of a five-year English contract",
      "Left England for Spain in a January window, and left Spain in one too",
    ],
  },
  {
    key: "tevez",
    display: "Carlos Tevez",
    nationality: "Argentina",
    international: { team: "Argentina", from: 2004, to: 2015 },
    spells: [
      { team: "Boca Juniors", from: 2001, to: 2004 },
      { team: "West Ham United", from: 2006, to: 2006, england: "top" },
      { team: "Manchester United", from: 2007, to: 2008, england: "top" },
      { team: "Manchester City", from: 2009, to: 2012, england: "top" },
      { team: "Juventus", from: 2013, to: 2014 },
      { team: "Boca Juniors", from: 2018, to: 2020 },
    ],
    notes: [
      "Kept a club in the division on the last day, and the deal that brought him caused a hearing",
      "Crossed a city and won the league on both sides of it",
      "Went home twice",
    ],
  },
  {
    ...
    nationality: "France",
    international: { team: "France", from: 1997, to: 2010 },
    spells: [
      { team: "Monaco", from: 1994, to: 1998 },
      { team: "Juventus", from: 1998, to: 1998 },
      { team: "Arsenal", from: 1999, to: 2006, england: "top" },
      { team: "Barcelona", from: 2007, to: 2009 },
      { team: "New York Red Bulls", from: 2010, to: 2014 },
      { team: "Arsenal", from: 2011, to: 2011, loan: true, apps: 0, england: "top" },
    ],
    notes: [
      "Started as a winger and was moved to the middle by a manager who had signed him twice",
      "Half a season in Italy between two of the longest spells here",
      "Won a European Cup the season after leaving England, against the club he had left",
    ],
  },
  {
    key: "kluivert",
    display: "Patrick Kluivert",
    nationality: "Netherlands",
    international: { team: "Netherlands", from: 1994, to: 2004 },
    spells: [
      { team: "Ajax", from: 1994, to: 1996 },
      { team: "AC Milan", from: 1997, to: 1997 },
      { team: "Barcelona", from: 1998, to: 2003 },
      { team: "Newcastle United", from: 2004, to: 2004, england: "top" },
      { team: "Valencia", from: 2005, to: 2005 },
      { team: "PSV Eindhoven", from: 2006, to: 2006 },
    ],
    notes: [
      "Scored the winner in a European Cup final as a teenage substitute",
      "One season each at three of these clubs, five at another",
      "His country's record scorer when he stopped",
    ],
  },
  {
    key: "mkhitaryan",
    display: "Henrikh Mkhitaryan",
    nationality: "Armenia",
    spells: [
      { team: "Borussia Dortmund", from: 2013, to: 2015 },
      { team: "Manchester United", from: 2016, to: 2017, england: "top" },
      { team: "Arsenal", from: 2018, to: 2018, england: "top" },
      { team: "Roma", from: 2019, to: 2021 },
      { team: "Inter Milan", from: 2022, to: 2024 },
    ],
    notes: [
      "Swapped shirts with another forward in a straight exchange between two English clubs",
      "Missed a European final in his own country's neighbour over a passport",
      "Won a European trophy in Italy after two seasons in England without one",
    ],
  },
  {
    key: "loic-remy",
    display: "Loïc Rémy",
    nationality: "France",
    international: { team: "France", from: 2009, to: 2015 },
    spells: [
      { team: "Nice", from: 2008, to: 2009 },
      { team: "Marseille", from: 2010, to: 2012 },
      { team: "Queens Park Rangers", from: 2013, to: 2014, england: "top" },
      { team: "Newcastle United", from: 2013, to: 2013, loan: true, apps: 26, england: "top" },
      { team: "Chelsea", from: 2014, to: 2015, england: "top" },
      { team: "Crystal Palace", from: 2016, to: 2016, loan: true, apps: 21, england: "top" },
    ],
    notes: [
      "Signed for a relegated club and was loaned straight back to the division",
      "A medal in England from a season spent mostly on the bench",
      "Four English clubs in four years, three of them in London",
    ],
  },
  {
    key: "sol-campbell",
    display: "Sol Campbell",
    nationality: "England",
    international: { team: "England", from: 1996, to: 2007 },
    spells: [
      { team: "Tottenham Hotspur", from: 1992, to: 2000, england: "top" },
      { team: "Arsenal", from: 2001, to: 2005, england: "top" },
      { team: "Portsmouth", from: 2006, to: 2008, england: "top" },
      { team: "Arsenal", from: 2009, to: 2009, england: "top" },
      { team: "Newcastle United", from: 2010, to: 2010, england: "top" },
    ],
    notes: [
      "Left one north London club for the other on a free transfer",
      "Won the league without losing a game, and a cup with the club after that",
      "Came back to a club he had already left, nine years after joining it",
    ],
  },
  {
    key: "scott-parker",
    ...
    nationality: "England",
    international: { team: "England", from: 2003, to: 2013 },
    spells: [
      { team: "Charlton Athletic", from: 1997, to: 2003, england: "top" },
      { team: "Chelsea", from: 2004, to: 2004, england: "top" },
      { team: "Newcastle United", from: 2005, to: 2006, england: "top" },
      { team: "West Ham United", from: 2007, to: 2010, england: "top" },
      { team: "Tottenham Hotspur", from: 2011, to: 2012, england: "top" },
      { team: "Fulham", from: 2013, to: 2016, england: "top" },
    ],
    notes: [
      "Footballer of the Year in a season his club went down",
      "Six English clubs, five of them in London",
      "Managed three clubs in the division he spent his career in",
    ],
  },
  {
    key: "viduka",
    display: "Mark Viduka",
    nationality: "Australia",
    international: { team: "Australia", from: 1994, to: 2009 },
    spells: [
      { team: "Celtic", from: 1998, to: 1999 },
      { team: "Leeds United", from: 2000, to: 2003, england: "top" },
      { team: "Middlesbrough", from: 2004, to: 2006, england: "top" },
      { team: "Newcastle United", from: 2007, to: 2008, england: "top" },
    ],
    notes: [
      "Four in one game against the champions-elect",
      "Went to a World Cup at thirty, his country's first in thirty-two years",
      "Born in Australia, played once for the country his parents left",
    ],
  },
  {
    key: "ginola",
    display: "David Ginola",
    nationality: "France",
    international: { team: "France", from: 1990, to: 1995 },
    spells: [
      { team: "Paris Saint-Germain", from: 1992, to: 1994 },
      { team: "Newcastle United", from: 1995, to: 1996, england: "top" },
      { team: "Tottenham Hotspur", from: 1997, to: 1999, england: "top" },
      { team: "Aston Villa", from: 2000, to: 2001, england: "top" },
      { team: "Everton", from: 2001, to: 2001, england: "top" },
    ],
    notes: [
      "Both players' and writers' Footballer of the Year in the same season",
      "Blamed for a goal that cost his country a World Cup, and never picked again",
      "Never won a league title in England",
    ],
  },
  {
    key: "di-maria",
    ...
    nationality: "Argentina",
    international: { team: "Argentina", from: 2008, to: 2024 },
    spells: [
      { team: "Real Madrid", from: 2010, to: 2013 },
      { team: "Manchester United", from: 2014, to: 2014, england: "top" },
      { team: "Paris Saint-Germain", from: 2015, to: 2021 },
      { team: "Juventus", from: 2022, to: 2022 },
      { team: "SL Benfica", from: 2023, to: 2024 },
    ],
    notes: [
      "Man of the match in a European Cup final, sold that summer",
      "A British record fee for one season, then gone",
      "Scored in the finals of an Olympic tournament, a continental championship and a World Cup",
    ],
  },
  {
    key: "coutinho",
    display: "Philippe Coutinho",
    nationality: "Brazil",
    international: { team: "Brazil", from: 2010, to: 2022 },
    spells: [
      { team: "Inter Milan", from: 2010, to: 2012 },
      { team: "Liverpool", from: 2012, to: 2017, england: "top" },
      { team: "Barcelona", from: 2017, to: 2021 },
      { team: "Bayern Munich", from: 2019, to: 2019, loan: true, apps: 23 },
      { team: "Aston Villa", from: 2022, to: 2022, england: "top" },
    ],
    notes: [
      "A club record fee out of England, and a club record fee into Spain",
      "Scored against the club that had sold him, in a European Cup tie, while on loan elsewhere",
      "Reunited in England with a former teammate who was by then his manager",
    ],
  },
  {
    key: "mutu",
    ...
    nationality: "Romania",
    spells: [
      { team: "Inter Milan", from: 1999, to: 1999 },
      { team: "Parma", from: 2001, to: 2002 },
      { team: "Chelsea", from: 2003, to: 2003, england: "top" },
      { team: "Juventus", from: 2005, to: 2005 },
      { team: "Fiorentina", from: 2006, to: 2010 },
    ],
    notes: [
      "One season in England, ended by a failed test and a fee he was ordered to repay",
      "Top scorer in Italy's top division the season after he left England",
      "Joint record scorer for his country",
    ],
  },
  {
    key: "gullit",
    display: "Ruud Gullit",
    nationality: "Netherlands",
    international: { team: "Netherlands", from: 1981, to: 1994 },
    spells: [
      { team: "PSV Eindhoven", from: 1985, to: 1986 },
      { team: "AC Milan", from: 1987, to: 1992 },
      { team: "Sampdoria", from: 1993, to: 1994 },
      { team: "Chelsea", from: 1995, to: 1997, england: "top" },
    ],
    notes: [
      "Captained his country to a European Championship and dedicated the award before it",
      "Two European Cups in Italy, three years apart",
      "Became a player-manager in England and won a cup in his first season",
    ],
  },
  {
    key: "vialli",
    display: "Gianluca Vialli",
    nationality: "Italy",
    international: { team: "Italy", from: 1985, to: 1992 },
    spells: [
      { team: "Sampdoria", from: 1984, to: 1991 },
      { team: "Juventus", from: 1992, to: 1995 },
      { team: "Chelsea", from: 1996, to: 1998, england: "top" },
    ],
    notes: [
      "Won a league title at a club that had never won one, and has not since",
      "Captained the side that won a European Cup, then left that summer",
      "Player-manager in England, and won three trophies in it",
    ],
  },
  {
    key: "lombardo",
    display: "Attilio Lombardo",
    nationality: "Italy",
    international: { team: "Italy", from: 1990, to: 1998 },
    spells: [
      { team: "Sampdoria", from: 1989, to: 1994 },
      { team: "Juventus", from: 1995, to: 1996 },
      { team: "Crystal Palace", from: 1997, to: 1998, england: "top" },
      { team: "Lazio", from: 1999, to: 2000 },
    ],
    notes: [
      "Played in two European Cup finals for two different Italian clubs",
      "Briefly managed the English club on this list, while still playing for it",
      "Bald at twenty-five and nicknamed for it in two countries",
    ],
  },
  {
    key: "kewell",
    display: "Harry Kewell",
    nationality: "Australia",
    international: { team: "Australia", from: 1996, to: 2012 },
    spells: [
      { team: "Leeds United", from: 1995, to: 2002, england: "top" },
      { team: "Liverpool", from: 2003, to: 2007, england: "top" },
      { team: "Galatasaray", from: 2008, to: 2010 },
    ],
    notes: [
      "Came off injured in a European Cup final his side won from three down",
      "Young Player of the Year in England at twenty-one",
      "Left a semi-finalist for a club that had sold its best players, and both went down the table",
    ],
  },
  {
    key: "carbone",
    display: "Benito Carbone",
    nationality: "Italy",
    spells: [
      { team: "Napoli", from: 1994, to: 1994 },
      { team: "Inter Milan", from: 1995, to: 1995 },
      { team: "Sheffield Wednesday", from: 1996, to: 1998, england: "top" },
      { team: "Aston Villa", from: 1999, to: 2000, england: "top" },
      { team: "Middlesbrough", from: 2001, to: 2001, loan: true, apps: 21, england: "top" },
      { team: "Parma", from: 2003, to: 2003 },
    ],
    notes: [
      "A hat-trick in an FA Cup tie for a club he had joined on a free",
      "Eleven clubs, and never a full season at most of them",
      "Never capped, despite six seasons in Italy's top division",
    ],
  },
  {
    key: "dublin",
    display: "Dion Dublin",
    nationality: "England",
    international: { team: "England", from: 1998, to: 1998 },
    spells: [
      { team: "Manchester United", from: 1992, to: 1993, england: "top" },
      { team: "Coventry City", from: 1994, to: 1997, england: "top" },
      { team: "Aston Villa", from: 1998, to: 2003, england: "top" },
      { team: "Leicester City", from: 2004, to: 2004, england: "top" },
      { team: "Celtic", from: 2005, to: 2005 },
      { team: "Norwich City", from: 2006, to: 2007, england: "championship" },
    ],
    notes: [
      "Broke his leg six games into a move to the champions and never got the place back",
      "Shared the golden boot in a season his club finished eleventh",
      "Broke his neck, and played again four months later",
      "Played centre-forward and centre-half in the same seasons",
    ],
  },
];
...
export const CLUB_COUNTRY: Record<string, string> = {
  ...
  // Reached by the second seeding batch, once the picker was allowed to
  // look at the whole catalogue rather than only the teams already named.
  Sevilla: "Spain", Valencia: "Spain", Espanyol: "Spain", "Real Betis": "Spain",
  "Athletic Bilbao": "Spain",
  "SL Benfica": "Portugal",
  "Werder Bremen": "Germany",
  Torino: "Italy",
  Bordeaux: "France", Lens: "France",
  "Ipswich Town": "England", "Derby County": "England", "Sheffield United": "England",
  "Preston North End": "England", "Hull City": "England", "Swansea City": "Wales",
  "Heart of Midlothian": "Scotland", "Aberdeen FC": "Scotland",
};
